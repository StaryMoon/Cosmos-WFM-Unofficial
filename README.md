...
[Paper](https://arxiv.org/abs/2501.03575) · [PDF](https://arxiv.org/pdf/2501.03575) · [Issues](https://github.com/StaryMoon/Cosmos-WFM-Unofficial/issues) · [Release](https://github.com/StaryMoon/Cosmos-WFM-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="Cosmos-WFM-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2501.03575). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Venue / Source | World Models / arXiv 2025 |
| Focus | This repository organizes a PyTorch implementation for Cosmos World Foundation Model Platform for Physical AI, focusing on world foundation models for physical AI, video tokeniz... |
...
This repository organizes a PyTorch implementation for **Cosmos World Foundation Model Platform for Physical AI**, focusing on world foundation models for physical AI, video tokenization, and post-training. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/Cosmos-WFM-Unofficial.git
cd Cosmos-WFM-Unofficial
python -m venv .venv
...
```python
import torch
from cosmos_wfm_unofficial import ModelConfig, UnofficialModel, reconstruction_loss

config = ModelConfig(task="world", hidden_dim=128, num_layers=2, num_heads=4)
...
```python
import torch
from cosmos_wfm_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2501.03575) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2501.03575) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2501.03575) |
...
```bibtex
@article{CosmosWFM_2025,
  title   = {Cosmos World Foundation Model Platform for Physical AI},
  author  = {NVIDIA and : and Niket Agarwal and Arslan Ali and Maciej Bala and Yogesh Balaji and Erik Barker and Tiffany Cai and others},
...
- Thanks to the authors of **Cosmos World Foundation Model Platform for Physical AI** for the original research.
...
pytorch, unofficial-implementation, reproduction, world-model, physical-ai, cosmos, video-tokenizer, robotics
